...
parser.add_argument('--add-negatives', action='store_true',
                    help='whether use schema-based negatives')
parser.add_argument('--select-rank', default=2, type=int,
                    help='the rank of schema-based negatives')
...
parser.add_argument('--addictive-margin', default=0.0, type=float, metavar='N',
...
assert args.task.lower() in ['wn18rr', 'fb15k237', 'wiki5m_ind', 'wiki5m_trans', 'humans_wikidata', 'humans_wikidata_ind']
